...
public class CategoryAppService
{
    ...
    private string ErrorMessageForInvalidCategory(int? providedCategoryId) => $"Categoría con {providedCategoryId} no existe. Proporcione CustomCategory para crear una nueva.";
