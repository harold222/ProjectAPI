...
DROP TABLE [dbo].[Logs]
GO
/****** Object:  Table [dbo].[Category]    Script Date: 6/02/2023 2:53:36 p.m. ******/
...
GO
ALTER TABLE [dbo].[Post]  WITH CHECK ADD  CONSTRAINT [FK_Post_Customer] FOREIGN KEY([CustomerId])
REFERENCES [dbo].[Customer] ([CustomerId])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[Post] CHECK CONSTRAINT [FK_Post_Customer]
GO
...
GO
INSERT [dbo].[Category] ([CategoryId], [CategoryName]) VALUES (1, N'Farándula')
GO
INSERT [dbo].[Category] ([CategoryId], [CategoryName]) VALUES (2, N'Política')
GO
INSERT [dbo].[Category] ([CategoryId], [CategoryName]) VALUES (3, N'Futbol')
GO
...
GO
INSERT [dbo].[Post] ([PostId], [Title], [Body], [CategoryId], [CustomerId]) VALUES (1, N'Hola Amigos', N'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 1, 1002)
GO
INSERT [dbo].[Post] ([PostId], [Title], [Body], [CategoryId], [CustomerId]) VALUES (2, N'Amigos Perrunos', N'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 1, 4)
GO
INSERT [dbo].[Post] ([PostId], [Title], [Body], [CategoryId], [CustomerId]) VALUES (3, N'Soldado Caido!!!!', N'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 1, 1002)
GO
