...
public class CustomerAppService
{
    ...
    /// <summary>
    /// Used by PostService via HTTP to validate customer existence.
    /// </summary>
    public async Task<CustomerDto.Response?> GetByIdAsync(int id)
    {
    ...
    private static CustomerDto.Response MapToResponse(Customer c) => new()
    {
        Id = c.CustomerId,
        Name = c.Name
    };
